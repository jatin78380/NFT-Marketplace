...
contract NFTMarketplace is ERC721URIStorage, Ownable {
  ...
  uint256 public cost = 0.01 ether;  //minting cost
 ...
 function buyNFT(uint256 _id) external payable{
    ...
    require(msg.sender != minted[id].nftOwner, "Operation not allowed");
 ...
 function changePrice(uint256 _id, uint356 newPrice) external returns(bool){
...
function getALLNFTs() external view returns(MFTItems[] memory){
    return minted;
}
